      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-10 relative">
          ...
          <div className="bg-black/50 p-6 rounded-lg border border-primary/30 backdrop-blur-md relative tech-corner">
            ...
            <div className="space-y-3">              <div className="group flex items-center gap-3 p-2 hover:bg-primary/10 rounded-md transition-all cursor-pointer relative overflow-hidden">
                ...
                <div className="w-10 h-10 bg-primary/20 rounded-md flex items-center justify-center border border-primary/30 group-hover:border-primary/60 relative">
                  ...
                  <div className="absolute inset-0 border border-primary/0 group-hover:border-primary/30 rounded-md animate-ping" style={{animationDuration: "1.5s"}}></div>                </div>
                <div className="flex-1">
                  <SimpleWrapper>
                    <a href="https://github.com/zuhayr24" target="_blank" rel="noopener noreferrer" className="font-mono text-sm text-primary hover:text-primary/80 transition-colors flex items-center">
                      <span className="mr-2 terminal-prompt">github.com/zuhayr24</span>
              ...
              </div><div className="group flex items-center gap-3 p-2 hover:bg-primary/10 rounded-md transition-all cursor-pointer relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/10 to-transparent transform -translate-x-full group-hover:translate-x-full transition-transform duration-700"></div>
                <div className="w-10 h-10 bg-primary/20 rounded-md flex items-center justify-center border border-primary/30 group-hover:border-primary/60 relative">
                  ...
                  <div className="absolute inset-0 border border-primary/0 group-hover:border-primary/30 rounded-md animate-ping" style={{animationDuration: "1.5s"}}></div>                </div>                <div className="flex-1">
                  <SimpleWrapper>
                    <a href="https://www.linkedin.com/in/zuhayr" target="_blank" rel="noopener noreferrer" className="font-mono text-sm text-primary hover:text-primary/80 transition-colors flex items-center">
            ...
            <div className="bg-black/50 rounded-lg border border-primary/30 backdrop-blur-md p-6 relative tech-corner">
              ...
              <form ref={form} onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1 relative">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-primary/90 hover:bg-primary font-mono text-sm group relative overflow-hidden cursor-pointer"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-[#33C3F0] transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left opacity-20 pointer-events-none"></div>
                  </Button>
                </div>              </form>
